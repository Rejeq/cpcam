 ...
 * - The preview fills the available space without distortion
 * - The preview is centered in the available space
 *
 * @property aspectRatio The current aspect ratio of the view
 * @property size The current size of the view
 */
